...
class Order(models.Model):
    buyer = models.ForeignKey(MyUser, verbose_name='购买者', on_delete=models.SET_NULL, null=True)
    ...
    ORDER_STATUS = ((1, '交易中'), (2, '交易终止'), (3, '交易成功'))
...
class MyCollection(models.Model):
    goods = models.ForeignKey(Goods, verbose_name='商品', on_delete=models.SET_NULL, null=True)
    user = models.ForeignKey(MyUser, verbose_name='收藏者', on_delete=models.SET_NULL, null=True)
    create_time = models.DateTimeField(u'创建时间', auto_now_add=True)